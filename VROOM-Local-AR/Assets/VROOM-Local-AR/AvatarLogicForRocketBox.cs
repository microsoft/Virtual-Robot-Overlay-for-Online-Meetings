...
public class AvatarLogicForRocketBox : MonoBehaviour
{
    public static AvatarLogicForRocketBox instance;
    ...
    private void handMoveUpdate(string data)
    {
        ...
        Transform robotMarkerRoot = _AMPBody.transform.parent;
        leftHandTarget.position = robotMarkerRoot.position + leftHandPosition;
        rightHandTarget.position = robotMarkerRoot.position + rightHandPosition;

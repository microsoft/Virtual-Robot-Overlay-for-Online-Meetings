...
public class RocketBoxArmIK : MonoBehaviour
{
    ...
    private void Update()
    {
        effectorL = BodyDetectorForRocketBox.instance.leftHandTarget;
        effectorR = BodyDetectorForRocketBox.instance.rightHandTarget;
        enableLeftArm = BodyDetectorForRocketBox.instance.trackingLeftHand;
        enableRightArm = BodyDetectorForRocketBox.instance.trackingRightHand;
    }
